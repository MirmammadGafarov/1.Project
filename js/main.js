...
$(document).ready(function getProducts() {
  fetch("./js/new_products.json")
    ...
    .then((data) => {
      data.new_products.forEach(function (product) {
        document.getElementById(
          "addCard"
        ).innerHTML += `<div  class="col-lg-3 col-md-4 col-sm-6 col-12">
         <div class="new_brand" >
    ...
    .catch((error) => {
      ...
      document.getElementById(
        "addCard"
      ).innerHTML += `<div class="p-5" style="font-size:50px; background:#0fbfa8; font-weight:600">Please open index.html in Live Server, <br>in order to see Section_3 Objects :)<div/>`;
    });
});
